...
class ProductTest < ActiveSupport::TestCase
  ...
  # but if you really need to control which fixtures to load, below syntax is useful
  # fixtures :products
  # test "the truth" do
  #   assert true
  # end
  ...
  test "product is not valid without a unique title" do
    ...
    # if you want to avoid hardcoded string for the active record error, you can compare the response against its built-in error message table
